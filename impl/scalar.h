...
size_t scalar_find_first_stable_utf8_nfc(const uint8_t *input, size_t length);
size_t scalar_find_first_stable_utf8_nfkc(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf8_nfc(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf8_nfkc(const uint8_t *input, size_t length);
size_t scalar_find_first_stable_utf8_nfd(const uint8_t *input, size_t length);
size_t scalar_find_first_stable_utf8_nfkd(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf8_nfd(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf8_nfkd(const uint8_t *input, size_t length);
...
size_t scalar_find_first_stable_utf16le_nfc(const uint8_t *input,
                                            size_t length);
size_t scalar_find_first_stable_utf16be_nfc(const uint8_t *input,
                                            size_t length);
size_t scalar_find_first_stable_utf16le_nfkc(const uint8_t *input,
                                             size_t length);
size_t scalar_find_first_stable_utf16be_nfkc(const uint8_t *input,
                                             size_t length);
size_t scalar_find_last_stable_utf16le_nfc(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf16be_nfc(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf16le_nfkc(const uint8_t *input,
                                            size_t length);
size_t scalar_find_last_stable_utf16be_nfkc(const uint8_t *input,
                                            size_t length);
size_t scalar_find_first_stable_utf16le_nfd(const uint8_t *input,
                                            size_t length);
size_t scalar_find_first_stable_utf16be_nfd(const uint8_t *input,
                                            size_t length);
size_t scalar_find_first_stable_utf16le_nfkd(const uint8_t *input,
                                             size_t length);
size_t scalar_find_first_stable_utf16be_nfkd(const uint8_t *input,
                                             size_t length);
size_t scalar_find_last_stable_utf16le_nfd(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf16be_nfd(const uint8_t *input, size_t length);
size_t scalar_find_last_stable_utf16le_nfkd(const uint8_t *input,
                                            size_t length);
size_t scalar_find_last_stable_utf16be_nfkd(const uint8_t *input,
                                            size_t length);
